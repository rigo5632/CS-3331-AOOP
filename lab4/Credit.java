public class Credit extends Account{
  private int account_credit_max;
    ...
    public boolean transfer(Account checkingAccount, double amount){
        ...
        // checks if checking account has enough money
        if(checkingAccount.getBalance() < amount){
          System.out.println("\n********************");
          System.out.println("Amount is greater than Checking Balance!");
          System.out.println("********************\n");
          return false;
        }
        // updates balance
        super.updateBalance(super.getBalance() + amount);
        checkingAccount.updateBalance(checkingAccount.getBalance() - amount);
        return true;
    }
}
